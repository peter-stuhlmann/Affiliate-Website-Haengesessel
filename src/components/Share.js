  ...
  buttons: [
    {
      ...
      href: `whatsapp://send?text=${window.document.title}%20_${window.location.href}_`,
    },
    {
      title: 'Facebook',
      icon:
    ...
    },
    {
      ...
      href: `https://twitter.com/intent/tweet?text=${window.document.title}%20%2D%2D%2D%3E%20${window.location.href}`,
    },
    {
      title: 'LinkedIn',
      icon:
